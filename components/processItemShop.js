...
async function getCitas(id) {
  ...
  console.log(base_url(Api, `queries/client/${id}`))
...
async function getCitasByClient(id_client) {
  return await axios.get(base_url(Api, `get/request/cita/by/client/${id_client}`))
}
...
export { AllProcedures, AddCita, getCitas, getSedes, getMyPurchases, validateCupon, getCar, getShop, AddCar, deleteItem, deleteCar, likeMeADD, likeMeGET, likeMeDELETE, getcategories, getCitasByClient };
