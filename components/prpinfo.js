...
import { colorBack, primaryColor, modalBack } from '../Colors.js'
    ...
    return (
      ...
      <View style={{ backgroundColor: colorBack, alignItems: "center", bottom: 10, height: 40, marginBottom: -15 }}>
        ...
        <TouchableOpacity
          ...
          style={[style.btn_show, { backgroundColor: primaryColor }]}
        >
          <Icon name='alert-circle-outline' width={34} height={34} fill="#FFF" style={{ top: 3, left: 3 }} />
        </TouchableOpacity>
      </View>
        ...
        <View style={style.container}>
          <ScrollView scrollEventThrottle={16}>
            ...
            <Text style={style.parrafo}>
              ...
              fue creado para retribuir la confianza puesta por nuestras pacientes en nosotros y nuestros especialistas y la confianza que siguen depositando a la hora de recomendarnos con sus amig@s, familiares y vecinos.
              </Text>
              ...
              {"\n"}
              Cada que recomiendes a alguien con nosotros, entrarás a nuestra base de datos bajo un código que te será asignado, una vez dicha persona se opere con <Text style={style.negrita}>Dr. Daniel Andrés Correa Posada,</Text> vas a recibir una bonificación que puedes hacerla efectiva recibiendola de manera física, abonarla a cuotas de tu crédito o incluso que sea abonada para una próxima cirugía de tu preferencia.
              ...
              * Una vez que te registres a través de nuestro sitio web o en nuestra App serás parte de nuestro PRP y para referirnos con alguien lo podras hacer así:
              ...
              {"\n"}{"\n"}
              * Le puedes dar nuestra linea de atención <Text style={style.negrita}>3156311780</Text> en este caso debes indicarle a tu referida que debe dar tu nombre o código para que sepamos que fuiste tu quien la refirió.
              {"\n"}{"\n"}
              * Puedes darle el numero de tu referida a nuestra asesora en este numero de Whatsapp <Text style={style.negrita}>3156311780,</Text> nosotros nos encargaremos de contactarla y prestarle la asesoría.
