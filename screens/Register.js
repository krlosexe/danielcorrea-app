    ...
    <View style={styles.container}>
      ...
      <ImageBackground
        ...
        <ScrollView style={{ marginTop: 20, backgroundColor: "rgba(0,0,0,0.5)", }} scrollEventThrottle={16} >
          <View style={{ marginTop: "20%", width: "90%", alignItems: 'center', backgroundColor: "rgba(255,255,255,0.8)", alignSelf: "center", borderRadius: 20, paddingTop: 30, paddingBottom: 30 }}>
          ...
          <Image
            style={styles.icon}
            source={require('../src/images/logo_white.png')}
          />
        </ScrollView>
      </ImageBackground>
    </View>
