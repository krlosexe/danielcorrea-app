      ...
      return (
        ...
        <View style={styles.contained}>
            ...
            <View style={styles.wrap}>
                <View style={{ alignItems: "center", backgroundColor: "#FFF", width: "100%", borderRadius: 20, padding: 5, alignSelf: "center", alignContent: "center" }}>
                  <Text>Gesstiona y administra tu citas con nuestro grupo quirúrgico. El  mejor equipo de cirugía plástica del país.</Text>
                </View>
            </View>

          
          <View style={styles.group}>
            <TouchableOpacity style={styles.head} onPress={() => { setOpen1(!open1) }}>
          ...
          <View style={styles.group}>
            <TouchableOpacity style={styles.head} onPress={() => { setOpen5(!open5) }}>
          ...
          <View style={styles.group}>
            <TouchableOpacity style={styles.head} onPress={() => { setOpen2(!open2) }}>
          ...
          <View style={styles.group}>
            <TouchableOpacity style={styles.head} onPress={() => { setOpen3(!open3) }}>
          ...
          <View style={styles.group}>
            <TouchableOpacity style={styles.head} onPress={() => { setOpen4(!open4) }}>
          ...
          <View style={styles.group}>
            <TouchableOpacity style={styles.head} onPress={() => { setOpen6(!open6) }}>
          ...
          <View style={styles.group}>
            <TouchableOpacity style={styles.head} onPress={() => { setOpen7(!open7) }}>
      ...
      <ImageBackground source={require('../src/images/background.png')} style={{ flex: 1, justifyContent: "flex-end", resizeMode: "cover", width: "100%", height: "100%" }}>
        ...
        <View style={{ alignItems: "center", bottom: 5, }}>
          <TouchableOpacity
            ...
            <Icon name='plus' width={35} height={35} fill={colorLight} />
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  arrow: {
    marginRight: 15, top: 4, marginLeft: 5, marginRight: 5,
  },
  number: {
    left: 5, top: 4, alignItems: "center", alignContent: "center", borderRadius: 10, borderWidth: 1, borderColor: colorTertiary, width: 20, height: 20
  },
  numberText: { lineHeight: 18 },
  wrap: {
    shadowColor: "#000",
    shadowOffset: {
      width: 0,
    ...
    shadowRadius: 4.65,
    elevation: 2,
    backgroundColor: colorLight, padding: 10, borderBottomWidth: 1, borderBottomColor: "#c3c3c3", margin: 2
  },
  row: { flexDirection: "row" },
  text1: { fontWeight: "bold", fontSize: 15, width: "35%", textAlign: "right", paddingRight: 5, textTransform: "capitalize" },
  text2: { fontSize: 13 }
})