...
import { ImageBackground, Image,StyleSheet, SafeAreaView, StatusBar, ScrollView, FlatList, View, Text, RefreshControl, TouchableOpacity,} from 'react-native'
...
function WishList(props) {
  ...
  async function Get() {
    getCarLocal()
    const MeGusta = await likeMeGET(userDetails.id)
    setLike(MeGusta)
    setLoad(false)
  }
