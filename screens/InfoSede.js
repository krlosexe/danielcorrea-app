...
import { SafeAreaView, StatusBar, ImageBackground, View, Text, TouchableOpacity, ScrollView, Image, StyleSheet, } from "react-native";
  ...
  return (
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F3F3F3" }}>
      ...
      <ImageBackground source={require('../src/images/background.png')} style={{ flex: 1, justifyContent: "flex-end", resizeMode: "cover", width: "100%", height: "100%" }}>
        ...
        <ScrollView scrollEventThrottle={16} style={stylesVanues.scroll_view_pharmacy_slide} showsHorizontalScrollIndicator={true}>
